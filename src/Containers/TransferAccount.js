...
const TransferAccount = props => {
  ...
  function sendAmount() {
    ...
    let Timer = setTimeout(() => {
      // string ConcatStr = transactionType + transactionDate.ToString("MMddyyyyHHmmss") +
      // amount + currency + senderAccountNumber + beneficiaryAccountNumber +
      // sender + receiver + TransactionId;
      const date = new Date();
