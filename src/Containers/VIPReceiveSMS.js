...
function TransferReceiveSMS(props) {
  ...
  return (
    <Container>
      <VerifyModal
        ...
        title={Translate('Pay Cash Using Phone Number')}
      ...
      <KeyboardAwareScrollView>
        <Body>
          <TitleText>{Translate('Pay Cash Using Phone Number')}:</TitleText>
          <SubtitleText>
...
export default connect(mapStateToProps, mapDispatchToProps)(TransferReceiveSMS);
