...
export default class Steps extends Component {
  constructor(props) {
    ...
    this.borderRadiusAnim = new Animated.Value(
      this.state.configs.stepIndicatorSize / 2,
    );
  }
  ...
  onCurrentPositionChanged = position => {
    ...
    const animateToPosition =
      (this.state.progressBarSize / (count - 1)) * position;
    ...
    Animated.sequence([
      ...
      Animated.parallel([
        Animated.timing(this.sizeAnim, {
          toValue: this.state.configs.currentStepIndicatorSize,
          duration: 100,
          useNativeDriver: false, // Add This line
        }),
